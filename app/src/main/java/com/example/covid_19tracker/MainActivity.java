...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    TextView todaytotal,total,active,todayactive,recovered,todayrecovered,deaths,todaydeaths;
    TextView filter;
    String country;
    Spinner spinner;
    PieChart pieChart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       deaths = findViewById(R.id.totaldeath);
       ...
       spinner = findViewById(R.id.spinner);
        ...
        adapter = new com.example.covid_19tracker.Adapter(getApplicationContext(),modelClassList2);
...
//
    ...
    private void updateGraph(int active, int total, int recovered, int deaths) {
        ...
        pieChart.addPieSlice(new PieModel("Active",total, Color.parseColor("#FF4CAF50")));
        pieChart.addPieSlice(new PieModel("Recovered",total, Color.parseColor("#38ACCD")));
        pieChart.addPieSlice(new PieModel("Deaths",total, Color.parseColor("#F55C47")));
